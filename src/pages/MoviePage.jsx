    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative z-20 lg:pl-10 px-5 pt-5">
                    {/* Back Button */}
                    <div className="">
                        <Button
                            variant="ghost"
                            onClick={() => window.history.back()}
                            className="group text-white px-4 py-2 rounded-full transition-all"
                        >
                ...
                <div className="relative z-20 container mx-auto lg:px-50 px-7 lg:py-16 py-5">
